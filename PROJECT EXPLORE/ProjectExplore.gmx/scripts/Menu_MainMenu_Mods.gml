...
draw_sprite_ext(spr_menu_sub,0,640,360*button_slide,1.25,1,0,c_white,1);
...
draw_text(640,255*button_slide,string_split("This feature has not yet been fully implemented. Mods are functional but this menu is not.",510));
...
// Ok
scr_button_handle(0,640,(410+offset)*button_slide,120,36,font_gulim_22,fa_center,fa_middle,"Ok");

if ( mouse_check_button_released(mb_left) ){
if ( mouse_over == button_select ){
switch(button_select){
case 0:{
menu_state="Main";surface_update=true;button_slide=0;break;}
}}button_select=-2;}
